...
// Todo
// - Restrict the page to 100vh; what I mean is make the Index component 95VH and the footer 5VH so that the footer is always at the bottom of the page.
// - Add a way back from the What's New page to the main page.
// - Start working on user dashboard and user storage. (Till then this app is just a tool not a platform.)