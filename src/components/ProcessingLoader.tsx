  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 animate-fade-in">
      <div className="relative">
        ...
        <div className="relative bg-white dark:bg-card rounded-full p-6 shadow-lg border border-royal-200 dark:border-royal-800">
          <Loader className="h-8 w-8 text-royal-500" />
        </div>
      </div>
      <h3 className="text-xl font-semibold text-gray-800 dark:text-foreground mt-6 mb-2">
      ...
      <div className="mt-6 w-64 bg-gray-200 dark:bg-muted rounded-full h-2 overflow-hidden">
